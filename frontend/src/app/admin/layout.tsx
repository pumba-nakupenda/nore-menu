    ...
    return (
        <div className="min-h-screen bg-[#fdfcfb] flex font-sans selection:bg-[#064e3b]/10 selection:text-[#064e3b]">
            ...
            <main className="flex-1 overflow-y-auto relative h-screen">
                <header className="sticky top-0 z-10 bg-[#fdfcfb]/80 backdrop-blur-md border-b border-black/5 px-6 py-4 flex justify-between items-center lg:justify-end">
                    <button 
                        onClick={() => setIsSidebarOpen(true)}
                        className="lg:hidden p-2 text-zinc-500 hover:text-[#064e3b] transition-colors"
                    >
                    ...
                    <div className="flex items-center gap-4">
                        <button 
                            ...
                            className="hidden sm:flex items-center gap-2 px-4 py-2 bg-emerald-50 text-[#064e3b] rounded-xl text-xs font-bold hover:bg-emerald-100 transition-all border border-emerald-100"
                        >
                            <Globe className="w-3.5 h-3.5" />
                            View Public Menu
                        </button>
                        <div className="h-8 w-[1px] bg-black/5 mx-2 hidden sm:block"></div>
                        <button className="p-2 text-zinc-400 hover:text-[#064e3b] transition-colors relative">
                            <span className="absolute top-2 right-2 w-2 h-2 bg-[#c5a059] rounded-full border-2 border-[#fdfcfb]"></span>
